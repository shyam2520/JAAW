  ...
  return (
    <div className="  flex justify-between  mb-4">
      ...
      <div className=" flex flex-row font-Carousel-text text-sm  pt-1 mr-4">
        <div className={`topanimemenu ${switchanimeData.duration==='day'?'text-white':'text-gray-400'} `} onClick={()=>{changeDuration('day',switchanimeData.settopanimeData)}}>Today</div>
        <div className={`topanimemenu ${switchanimeData.duration==='week'?'text-white':'text-gray-400'}  `} onClick={()=>{changeDuration('week',switchanimeData.settopanimeData)}} >Week</div>
        <div className={`topanimemenu ${switchanimeData.duration==='month'?'text-white':'text-gray-400'} `} onClick={()=>{changeDuration('month',switchanimeData.settopanimeData)}}>Month</div>
      </div>
    </div>
  );
}
...
function TopAnime() {
  const [topanimeData, settopanimeData] = useState({ isLoading: true , duration:'day' });
  if (topanimeData.isLoading) {
    ...
    return (
      <div className=" px-5 pt-5 pb-2 bg-gray-800 rounded-md ">
        <TopAnimeMenu switchanimeData={{...topanimeData,settopanimeData:settopanimeData}}/>
